...
"""
    bfut_NfsTgaConverter (3toM).py - convert NFS3 tga texture alpha channel to MCO

USAGE
    python "bfut_NfsTgaConverter (3toM).py" </path/to/file.tga> [/path/to/output.tga]
    python "bfut_NfsTgaConverter (3toM).py" [</path/to/directory>]
...
CONFIG = {
    "conversion" : "3M",  # "34"|"43"|"4M"|"M4"|"3M"|"M3"
