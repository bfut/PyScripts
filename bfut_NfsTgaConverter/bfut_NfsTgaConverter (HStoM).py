...
USAGE
    python "bfut_NfsTgaConverter (HStoM).py" </path/to/file.tga> [/path/to/output.tga]
    python "bfut_NfsTgaConverter (HStoM).py" [</path/to/directory>]
...
CONFIG = {
    "conversion" : "4M",  # "34"|"43"|"4M"|"M4"|"3M"|"M3"
