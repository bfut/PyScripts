...
"""
    bfut_NfsTgaConverter (MtoHS).py - convert MCO tga texture alpha channel to NFSHS

USAGE
    python "bfut_NfsTgaConverter (MtoHS).py" </path/to/file.tga> [/path/to/output.tga]
    python "bfut_NfsTgaConverter (MtoHS).py" [</path/to/directory>]
...
CONFIG = {
    "conversion" : "M4",  # "34"|"43"|"4M"|"M4"|"3M"|"M3"
